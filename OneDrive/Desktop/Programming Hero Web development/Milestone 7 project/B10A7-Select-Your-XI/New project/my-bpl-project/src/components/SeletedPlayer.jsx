...
const SeletedPlayer = ({selectedP,updatePlayerA, coins, setCoins}) => {
    ...
    return (
        <div className="gap-3 mb-3">
            {
                selectedP.map(player => (<SelectedCard coins={coins} setCoins={setCoins} player = {player} handleRemovePlayer={handleRemovePlayer}></SelectedCard>))
            }
